...
const CnnModel = () => {
  ...
  const predictImage = async () => {
    ...
    const model = await tf.loadLayersModel(
      "https://fynix-dev.github.io/OpenModels/models/model_cnn/model.json",
    );
    ...
    <section className="w-full h-screen flex items-center justify-center bg-bg">
      <div className="w-fit min-w-[45%] md:max-w-[70%] container">
        ...
        <div className="w-full h-auto flex items-center justify-center">
          ...
          <label
            htmlFor="image-input"
            className="w-auto h-auto pl-[12px] pr-[12px] pt-[8px] pb-[8px] border-2 border-black rounded-[8px] cursor-pointer hover:bg-black hover:text-white "
          >
            Upload Image
          </label>
        </div>
        ...
        <button
          id="predict-btn"
          className="w-full h-auto pl-[12px] pr-[12px] pt-[8px] pb-[8px] border-2 border-black bg-black text-white font-medium rounded-[8px] cursor-pointer"
        ...
        <div className="w-full h-auto flex flex-col items-center justify-center gap-[8px]">
          ...
          <div className="w-full h-auto flex flex-col items-center justify-center ">
            {pred.map((item, i) => (
              <p
                key={i}
                className="text-[#5e5e5e] text-[18px] font-medium nth-[1]:text-[20px] nth-[1]:font-bold nth-[1]:text-black"
              >
